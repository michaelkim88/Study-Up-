...
struct SampleFlashcardData {
    ...
    func MathSampleSet() -> FlashcardSet {
        let mathSet = FlashcardSet(title: "Math Basics")
        ...
        for card in flashcards {
            mathSet.append(flashcard: card)
        }
        
        return mathSet
    }
    
    func HistorySampleSet() -> FlashcardSet {
        let historySet = FlashcardSet(title: "History")
        ...
        for card in flashcards {
            historySet.append(flashcard: card)
        }
    ...
    func ScienceSampleSet() -> FlashcardSet {
        let scienceSet = FlashcardSet(title: "Science")
        ...
        for card in flashcards {
            scienceSet.append(flashcard: card)
        }
        
        return scienceSet
    }
    
    func LangSampleSet() -> FlashcardSet {
        let languageSet = FlashcardSet(title: "Language Basics")
        ...
        for card in flashcards {
            languageSet.append(flashcard: card)
        }
